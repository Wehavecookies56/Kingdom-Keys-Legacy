...
public class ModelKingdomKey extends ModelBase
{
	...
	{
		modelTutBox = AdvancedModelLoader.loadModel("/assets/kk/models/KingdomKey.obj");
	}
	public void render()
	{
		modelTutBox.renderAll();
	}
	public ResourceLocation resourceloc2 = new ResourceLocation("kk:textures/entities/KingdomKey.png");
