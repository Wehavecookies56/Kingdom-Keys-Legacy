...
public class GuiSynthesiser extends GuiContainer {
	...
	public static final ResourceLocation texture = new ResourceLocation("kk", "textures/gui/SynthesiserGui.png");
	
	public GuiSynthesiser(InventoryPlayer invPlayer, TileEntitySynthesiser entity) {
