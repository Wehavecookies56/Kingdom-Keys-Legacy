...
public class Reference {
    ...
    public static final String MOD_VER = "0.3.0.1.6.1 Alpha";
    public static final String MOD_DEP = "required-after:Forge";
    public static final String CHANNEL_NAME = "wehavecookies56";
    
    public static final String ADDONTC_ID = "kktc";
    public static final String ADDONTC_NAME = "Kingdom Keys Thaumcraft addon";
    public static final String ADDON_DEPEND = "required-after:kk";
