...
public class BlockTranquilOre extends BlockBlox {
    ...
    public BlockTranquilOre(int id, Material par2Material) {
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        */
        ...
        for(int i = 0; i < count; i++)
        {
        	...
        	if (luckDraw == 1) { 
        		idDropped = AddedItems.TranquilStone.itemID;
        		metaDropped = 0;
        		
        	}
        	if (luckDraw == 2) { 
        		idDropped = AddedItems.TranquilGem.itemID;
        		metaDropped = 0;
        		
        	}
        	if (luckDraw == 3) { 
        		idDropped = AddedItems.TranquilCrystal.itemID;
        		metaDropped = 0;
