...
public class BlockEnergyOre extends BlockBlox {
    ...
    public BlockEnergyOre(int id, Material par2Material) {
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        */
        ...
        for(int i = 0; i < count; i++)
        {
        	...
        	if (luckDraw == 1) { 
        		idDropped = AddedItems.EnergyStone.itemID;
        		metaDropped = 0;
        		
        	}
        	if (luckDraw == 2) { 
        		idDropped = AddedItems.EnergyGem.itemID;
        		metaDropped = 0;
        		
        	}
        	if (luckDraw == 3) { 
        		idDropped = AddedItems.EnergyCrystal.itemID;
        		metaDropped = 0;
