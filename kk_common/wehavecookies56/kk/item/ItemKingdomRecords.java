...
public class ItemKingdomRecords extends Item
{
    ...
    protected ItemKingdomRecords(int par1, String par2Str)
    {
        super(par1);
    ...
    {
        return "Square Enix - " + this.recordName;
     ...
     */
    public static ItemKingdomRecords getRecord(String par0Str)
    {
        return (ItemKingdomRecords)records.get(par0Str);
    }
