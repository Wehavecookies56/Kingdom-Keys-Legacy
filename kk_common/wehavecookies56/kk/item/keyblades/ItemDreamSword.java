...
public class ItemDreamSword extends ItemSword {
    ...
    public ItemDreamSword(int id, EnumToolMaterial kingdomkey12) {
        super(id, kingdomkey12);
	...
	if (this.keyPressed)
	{
		...
		if (player.getHeldItem() != null && player.getHeldItem().itemID == AddedItems.K42.itemID)
		{
			player.inventory.setInventorySlotContents(player.inventory.currentItem, new ItemStack(AddedItems.K42c));
		}
	}
    }
}