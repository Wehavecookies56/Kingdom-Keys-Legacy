...
public class ItemJungleKing extends ItemSword {
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemJungleKing(int id, EnumToolMaterial kingdomkey33) {
        super(id, kingdomkey33);
	...
	if (this.keyPressed)
	{
		...
		{
			player.inventory.setInventorySlotContents(player.inventory.currentItem, new ItemStack(AddedItems.K99c));
		}
	}
    }
}