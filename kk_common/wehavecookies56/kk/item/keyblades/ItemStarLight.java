...
public class ItemStarLight extends ItemSword {
	...
	if (this.keyPressed)
	{
		...
		if (player.getHeldItem() != null && player.getHeldItem().itemID == AddedItems.K107.itemID)
		{
			player.inventory.setInventorySlotContents(player.inventory.currentItem, new ItemStack(AddedItems.K107c));
		}
	}
    }
}