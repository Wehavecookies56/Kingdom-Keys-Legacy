...
public class ItemEarthShaker extends ItemSword {
    ...
    public ItemEarthShaker(int id, EnumToolMaterial earthShakerMaterial) {
        super(id, earthShakerMaterial);
	...
	if (this.keyPressed)
	{
		...
		if (player.getHeldItem() != null && player.getHeldItem().itemID == AddedItems.K109.itemID)
		{
			player.inventory.setInventorySlotContents(player.inventory.currentItem, new ItemStack(AddedItems.K109c));
		}
	}
    }
}