...
public class ItemWaywardWind extends ItemSword {
    ...
    public ItemWaywardWind(int id, EnumToolMaterial waywardWindMaterial) {
        super(id, waywardWindMaterial);
	...
	if (this.keyPressed)
	{
		...
		if (player.getHeldItem() != null && player.getHeldItem().itemID == AddedItems.K110.itemID)
		{
			player.inventory.setInventorySlotContents(player.inventory.currentItem, new ItemStack(AddedItems.K110c));
		}
	}
    }
}