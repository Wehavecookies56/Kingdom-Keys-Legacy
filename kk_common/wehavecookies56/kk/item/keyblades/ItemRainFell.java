...
public class ItemRainFell extends ItemSword {
	...
	if (this.keyPressed)
	{
		...
		if (player.getHeldItem() != null && player.getHeldItem().itemID == AddedItems.K108.itemID)
		{
			player.inventory.setInventorySlotContents(player.inventory.currentItem, new ItemStack(AddedItems.K108c));
		}
	}
    }
}