...
public class AddedItems {
	...
	public static void initBooks(){
		...
		//K7r = new ItemYoungXehanortRecipe(IDs.K7r).setUnlocalizedName(Strings.YoungxehanortskeybladeRecipe).setCreativeTab(KingdomKeys.KHDDDTAB).setMaxStackSize(chainStackSize);
		...
		//K21r = new ItemKyeBladeBrokenRecipe(IDs.K21r).setUnlocalizedName(Strings.KyebladebrokenRecipe).setCreativeTab(KingdomKeys.KHBBSTAB).setMaxStackSize(chainStackSize);
		...
		//K39r = new ItemXehanortsKeybladeRecipe(IDs.K39r).setUnlocalizedName(Strings.XehanortskeybladeRecipe).setCreativeTab(KingdomKeys.KHBBSTAB).setMaxStackSize(chainStackSize);
		...
		//K47r = new ItemMaverickFlareRecipe(IDs.K47r).setUnlocalizedName(Strings.MaverickflareRecipe).setCreativeTab(KingdomKeys.KHDAYSTAB).setMaxStackSize(chainStackSize);
		...
		//K68r = new ItemBondOfFlameRecipe(IDs.K68r).setUnlocalizedName(Strings.BondofflameRecipe).setCreativeTab(KingdomKeys.KHIITAB).setMaxStackSize(chainStackSize);
		...
		//K87r = new ItemWayToTheDawnRecipe(IDs.K87r).setUnlocalizedName(Strings.WaytodawnRecipe).setCreativeTab(KingdomKeys.KHIITAB).setMaxStackSize(chainStackSize);
		...
		//K102r = new ItemPeoplesHeartsRecipe(IDs.K102r).setUnlocalizedName(Strings.PeoplesheartsRecipe).setCreativeTab(KingdomKeys.KHTAB).setMaxStackSize(chainStackSize);
		...
		K111r = new ItemKingdomKeyRecipe(IDs.K111r).setUnlocalizedName(Strings.KingdomKeyRecipe).setCreativeTab(KingdomKeys.KHTAB).setMaxStackSize(chainStackSize);
